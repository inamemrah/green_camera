...
public class showscreenshot2 : MonoBehaviour {
	...
	public GameObject ssButton,backButton,colorButton,testColor,Slider_T,Text_t,Slider_S,Text_S;
	...
	public void ScreenShot()
	{
		if (Input.GetKeyUp(KeyCode.Mouse0))
		{
			...
			testColor.SetActive (false);
			Slider_T.SetActive (false);
			Text_t.SetActive (false);
			Slider_S.SetActive (false);
